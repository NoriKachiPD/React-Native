...
const ProductDetailScreen = () => {
  ...
  return (
    <View style={styles.container}>
      <StatusBar
        barStyle="dark-content" // Chữ đen trên nền trắng
        backgroundColor="#FFFFFF" // Nền trắng khớp với header
      />
...
const styles = StyleSheet.create({
  ...
  scrollContent: {
    padding: 15,
    alignItems: 'center',
    paddingBottom: 0, // Giảm từ 30 để marginBottom của backButton quyết định khoảng cách
  },
  imageContainer: {
