...
type AddCategoryScreenNavigationProp = NativeStackNavigationProp<RootStackParamList, 'AddCategoryScreen'>;
...
const AddCategoryScreen = () => {
  ...
  const onSaveCategory = async () => {
    ...
    try {
      await ProductDatabase.addCategory(categoryToSave);
      Alert.alert('Thành công', 'Thêm danh mục thành công');
      navigation.goBack();
    } catch (e) {
      console.error('Error adding category:', e);
      Alert.alert('Lỗi', 'Thêm danh mục thất bại');
    }
  };
